...
class Deck {
    private:
        ...
        size_t countOfCardsInDeck = 52;
        Cards * deck = nullptr;
    
    public:
    
        Deck ();
        Deck (size_t newCountOfCardsInDeck);
        Deck (size_t newCountOfCardsInDeck, int num, suitCard suit);
        ~Deck();
        ...
        void addCard(size_t numberOfCardInDeck, const Cards & test) throw(size_t, const std::exception &);
